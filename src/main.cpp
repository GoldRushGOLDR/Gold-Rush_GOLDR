...
#if defined(NDEBUG)
# error "GOLDRUSHCOIN cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x70b9f1e211d2d916e1aba912ca76038c3a4aba289a15d12c3119e7528e70c390");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // GOLDRUSHCOIN: starting difficulty is 1 / 2^12
...
{
    // GOLDRUSHCOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // GOLDRUSHCOIN: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // GOLDRUSHCOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x70b9f1e211d2d916e1aba912ca76038c3a4aba289a15d12c3119e7528e70c390");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1435177816, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "24/Jun/2015 Team GOLDRUSHCOIN 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xaf4564a8af4e507264302a96d2199444fb8d723de8a50f53c40bb5f82438b4bb"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // GOLDRUSHCOIN: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GOLDRUSHCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GOLDRUSHCOINMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static GOLDRUSHCOINMiner(CWallet *pwallet)
{
    printf("GOLDRUSHCOINMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("goldrushcoin-miner");
    ...
    try { loop {
        ...
        printf("Running GOLDRUSHCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GOLDRUSHCOINMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&GOLDRUSHCOINMiner, pwallet));
}
